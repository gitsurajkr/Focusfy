    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-balance">Focusfy</h1>
          <p className="text-sm text-muted-foreground mt-1">Productivity Manager</p>
        </div>
        ...
        >
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <Link href="/forgot-password" className="text-primary hover:text-primary/80 transition-smooth font-medium">
              Forgot password?
            </Link>
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-gradient-to-r from-primary to-secondary text-primary-foreground font-semibold py-2.5 rounded-lg transition-smooth hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
          >
